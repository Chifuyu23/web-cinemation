<html>
  ...
  <body>
    <div class="w-full h-screen flex flex-col relative">
      <!-- Background -->
      <img class="w-full h-screen absolute object-cover lg:object-fill" src="{{ $movieData->backdrop_path }}"/>
      ...
      <div id="trailerWrapper" class="absolute z-10 w-full h-screen p-20 bg-black flex flex-col">
        ...
        <iframe id="youtubeVideo" class="w-full h-full" src="https://www.youtube.com/embed/{{ $movieData->youtube_id }}?enablejsapi=1" title="{{ $movieData->title }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
      @endif
    </div>

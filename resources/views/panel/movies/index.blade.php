        ...
        <div class="w-full flex flex-row mt-16 mb-20 px-10">
          ...
          <div class="flex flex-col w-full ml-12 bg-white p-10 rounded-2xl drop-shadow-[0_0px_2px_rgba(0,0,0,0.2)] overflow-x-scroll">
            <div class="flex flex-row items-center">
              <div class="font-semibold text-3xl">Data Movies</div>
              ...
              <a href="{{ route('movies.import_form') }}" class="rounded-md bg-orange-500 text-white px-4 py-2 w-fit ml-3 hover:drop-shadow-xl duration-300">Impor data</a>
            </div>
            ...
            <div class="overflow-x-scroll">
              <table class="table-auto w-full mt-5">
                ...
                <tbody class="text-center">
                  @foreach($movies as $key => $item)
                    ...
                    <tr class="border">
                      <td class="p-4">{{ $movies->firstItem() + $key }}</td>
              ...
              <div class="mt-4">{{ $movies->onEachSide(0)->links() }}</div>
            </div>
